...
/* C LALR(1) parser skeleton written by Richard Stallman, by
   simplifying the original so-called "semantic-analyzer" parser.  */
...
/* The semantic-analyzer value of the lookahead symbol.  */
YYSTYPE yylval;
...
yyparse (void)
{
    ...
    /* The stacks and their tools:
       ...
       'yyvs': related to semantic-analyzer values.
    ...
    /* The semantic-analyzer value stack.  */
  ...
  /* The variables used to return semantic-analyzer value and location from the
     action routines.  */
  YYSTYPE yyval;
...
#line 1773 "calc.c"
  ...
  /* User semantic-analyzer actions sometimes alter yychar, and that requires
     that yytoken be updated with the new translation.  We take the
     approach of translating immediately before every use of yytoken.
     One alternative is translating here after every semantic-analyzer action,
     but that translation would be missed if the semantic-analyzer action invokes
...
yyerrlab:
  /* Make sure we have latest lookahead translation.  See comments at
     user semantic-analyzer actions for why this is necessary.  */
